export const Logo = ({ width = 40, height = 42 }) => {
  return (
    <svg
      id="logo"
        ...
        >
          <g transform="translate(825.000000, 1100.000000)">
            ...
            >
              ...
              <use id="Circle-Background" fill="#E6E6E6" href="#react-path-1" />
              <g
            ...
            >
              ...
              >
                ...
                <mask id="react-mask-376" fill="white">
                  <use href="#react-path-375" />
                </mask>
                <use
                  id="Clothes"
                  fill="#E6E6E6"
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-489" fill="white">
                  <use href="#react-path-491" />
                </mask>
                <g id="Mask" />
                <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-489)">
                  <g transform="translate(-1.000000, 0.000000)">
                    ...
                    <mask id="react-mask-488" fill="white">
                      <use href="#react-path-490" />
                    </mask>
                    <use
                      id="Short-Hair"
                      stroke="none"
